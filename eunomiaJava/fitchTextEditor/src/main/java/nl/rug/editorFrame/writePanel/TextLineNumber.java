...
public class TextLineNumber extends JPanel
     ...
     * Skips "assume" and "qed" lines
     * @param rowStartOffset the offset of the row.
     * @return the line number to draw.
     */
    protected String getTextLineNumber(int rowStartOffset) {
        ...
        try {
            ...
            if (line_text.contains(ProofSyntax.SUBPROOF_START) || line_text.contains(ProofSyntax.SUBPROOF_END)) {
                ...
                return String.valueOf(index + 1 - subproof_lines) + ".";
            } else {
                return "";
            }
