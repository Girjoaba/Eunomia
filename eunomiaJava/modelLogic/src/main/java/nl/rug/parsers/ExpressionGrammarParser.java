...
public class ExpressionGrammarParser extends Parser {
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode ATOM() { return getToken(ExpressionGrammarParser.ATOM, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExpressionGrammarVisitor ) return ((ExpressionGrammarVisitor<? extends T>)visitor).visitExpr(this);
