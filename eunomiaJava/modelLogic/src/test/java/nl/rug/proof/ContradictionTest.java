...
public class ContradictionTest {
    ...
    public void testContraIntro() {
        try {
            ...
            compiler.compile("testProofs/contradiction/contra_intro.txt");
    ...
    public void testContraElim() {
        try {
            ProofManager manager = new ProofManager();
            EunomiaCompiler compiler = new EunomiaCompiler(manager);
            compiler.compile("testProofs/contradiction/contra_elim.txt");
    ...
    public void testContraIntroJustificationOrderWrong() {
        try {
            ProofManager manager = new ProofManager();
            EunomiaCompiler compiler = new EunomiaCompiler(manager);
            compiler.compile("testProofs/contradiction/contra_intro_justification_order_wrong.txt");
